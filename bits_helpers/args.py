...
DEFAULT_WORK_DIR = (
    os.environ.get("BITS_WORK_DIR") or os.environ.get("ALICE_WORK_DIR") or "sw"
)
...
def doParseArgs():
  ...
  """
    ...
    build_parser.add_argument(
        ...
        default=1,
        help=(
            "The number of independent packages to build in parallel. "
            "Default is: %(default)d."
        ),
    )
    build_parser.add_argument(
        "--resource-monitoring",
        dest="resourceMonitoring",
        action="store_true",
  ...
  """,
    ...
    deps_parser.add_argument_group(title="Customise bits directories").add_argument(
        "-c",
        "--config-dir",
        dest="configDir",
        default="alidist",
