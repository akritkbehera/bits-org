...
GLOB_WITH_OBSOLETE_FILES = {
    ...
    "sw/osx_x86-64/b/latest*": [
        "sw/osx_x86-64/b/latest",
        "sw/osx_x86-64/b/latest-release",
        "sw/osx_x86-64/b/latest-root6",
    ],
    "sw/osx_x86-64/a/latest*": [
        "sw/osx_x86-64/a/latest",
        "sw/osx_x86-64/a/latest-release",
    ],
    "sw/osx_x86-64/*/*": [
        "sw/osx_x86-64/a/latest",
        "sw/osx_x86-64/a/v1",
...
class CleanTestCase(unittest.TestCase):
    ...
    def test_decideClean(self, mock_path, mock_os, mock_glob):
        ...
        toDelete = decideClean(
            workDir="sw", architecture="osx_x86-64", aggressiveCleanup=False
        )
        ...
        toDelete = decideClean(
            workDir="sw", architecture="osx_x86-64", aggressiveCleanup=True
        )
        self.assertEqual(
            toDelete,
            [
        ...
        toDelete = decideClean(
            workDir="sw", architecture="slc7_x86-64", aggressiveCleanup=True
        )
        self.assertEqual(
            toDelete,
            [
    ...
    def test_doClean(self, mock_log, mock_shutil, mock_path, mock_os, mock_glob):
        ...
        self.assertEqual(cm.exception.code, 0)
        mock_shutil.rmtree.assert_not_called()
        mock_log.banner.assert_called_with(
            "This %s delete the following directories:\n%s",
            "would",
            files_delete_formatarg,
        )
