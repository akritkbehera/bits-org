...
from bits_helpers.utilities import getPackageList, ver_rev
...
class RevisionPolicyTest(unittest.TestCase):
    def specs(self, defaults=None, force=None, overrides=None):
        ...
        with patch("bits_helpers.utilities.resolveFilename",
             ...
             patch("bits_helpers.utilities.getGeneratedPackages", return_value={"/recipes": {}}), \
             patch("bits_helpers.utilities.load_for_spec", return_value={}):
            getPackageList(
